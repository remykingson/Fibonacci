function CustomAlert() {
    ...
    this.render = function() {
        ...
        document.getElementById('dialogboxfoot').innerHTML = '<button class="button" onclick="Alert.ok()" style="background-color:dodgerblue;cursor:pointer; padding:3px 15px; border:none; color:#fff; border-radius:20px;">OK</button>';
    }
